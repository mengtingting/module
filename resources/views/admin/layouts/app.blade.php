...
<head>
    ...
    {{--可搜索下拉框样式--}}
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('js/drop-down-search/css/combo.select.css') }}"/>
...
{{--可搜索下拉框--}}
<script type="text/javascript" src="{{ URL::asset('/js/drop-down-search/js/jquery.combo.select.js') }}"></script>

{{--首页概览信息--}}
<script type="text/javascript" src="{{ URL::asset('dist/lib/hcharts/Highcharts/5.0.6/js/highcharts.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('dist/lib/hcharts/Highcharts/5.0.6/js/modules/exporting.js') }}"></script>
